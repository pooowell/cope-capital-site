    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-6">
      ...
      <div className="text-center max-w-2xl">
        <h1 className="text-5xl sm:text-7xl font-bold tracking-tight mb-4">
          cope<span className="text-cope-green">.</span>capital
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-cope-green text-black font-semibold px-8 py-4 rounded-lg hover:opacity-90 transition-opacity text-lg"
          >
      ...
      <div className="flex gap-12 mt-20 text-center">
        <div>
          <div className="text-3xl font-bold text-cope-green">890+</div>
          <div className="text-zinc-500 text-sm mt-1">wallets tracked</div>
        </div>
        <div>
          <div className="text-3xl font-bold text-cope-green">2</div>
          <div className="text-zinc-500 text-sm mt-1">chains</div>
        </div>
        <div>
          <div className="text-3xl font-bold text-cope-green">24/7</div>
